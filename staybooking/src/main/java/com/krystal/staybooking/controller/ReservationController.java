...
import com.krystal.staybooking.exception.InvalidReservationDateException;
...
public class ReservationController {
    ...
    //principal校验完reservation 存在用户的线程里 securitycontextholder验证完 获得context 得到authentication(extends principal) 获得当前user是谁
